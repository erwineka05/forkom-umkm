  ...
  return (
    <div className="container mx-auto px-6 py-12 bg-white">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Profil Kalurahan Umbulmartani</h1>
      ...
      <div className="grid md:grid-cols-3 gap-12">
        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Visi & Misi Kalurahan</h2>
            <div className="bg-red-50 p-6 rounded-xl border border-red-100">
              <h3 className="font-bold text-red-800 mb-2">Visi</h3>
              <p className="text-gray-700 italic mb-4">"Terwujudnya Masyarakat Umbulmartani yang Makmur, Berbudaya, dan Mandiri."</p>
        ...
        <div className="md:col-span-1 space-y-8">
          ...
          <div className="bg-white p-4 shadow-lg rounded-2xl border">
            <h3 className="font-bold text-gray-900 mb-4">Lokasi Kantor Kalurahan</h3>
            ...
            <p className="text-xs text-gray-500 mt-3 text-center">Jl. Kaliurang KM 13, Ngemplak, Sleman</p>
          </div>
